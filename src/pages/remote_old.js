...
import PureView from '../components/pureview';
...
//import labelReducer from '../redux/ducks/labelReducer';

//console.log("TRYING TO GET VARIABLE NAME");
//const variableName = useSelector((state) => state.labelReducer.commandLine);
...
export default class Remote extends React.Component {
    ...
    */
    ...
    render() {
        console.log("REMOTE PAGE IS RERENDERING 3");
